...
" format on enter, <cr> could be remapped by other vim plugin, also work with tpope/endwise
...
nnoremap <silent> <nowait> <space>dd  :<C-u>CocList diagnostics<cr>
" Manage extensions.
...
" Add `:Prettier` command to format the current buffer.
command! -nargs=0 Prettier :call CocAction('runCommand', 'prettier.formatFile')

"Add `:Spelling` command to toggle spell checking for the workspace
command! -nargs=0 SpellCheck :call CocAction('runCommand', 'cSpell.toggleEnableSpellChecker')
