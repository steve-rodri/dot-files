...
-- |  |        |  |
-- +---------------+
function hs.window.centerOnScreen(win)
  local f = win:frame()
  local screen = win:screen()
  local max = screen:fullFrame()
...
-- |     |      |     |
-- +------------------+
function hs.window.midThird(win)
  local f = win:frame()
  local screen = win:screen()
  local max = screen:frame()

  f.x = max.x + (max.w * 0.33)
  f.y = max.y
  f.w = max.w * 0.33
  f.h = max.h
  win:setFrame(f)
...
-- |           |     |
-- +-----------------+
function hs.window.leftTwoThirds(win)
  local f = win:frame()
  local screen = win:screen()
  local max = screen:frame()
...
-- |      |          |
-- +-----------------+
function hs.window.rightTwoThirds(win)
  local f = win:frame()
  local screen = win:screen()
  local max = screen:frame()
