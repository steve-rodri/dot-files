...
-- Use control + 0 to delete to beginning of line
--
-- In bash, control + 0 automatically deletes to the beginning of the line, so
...
enableHotkeyForWindowsMatchingFilter(wf, hs.hotkey.new({'ctrl'}, '0', function()
